...
import gama.studios.hoh4core.item.model.AdaptationWheelModel;
import gama.studios.hoh4core.item.AdaptationWheelItem;

public class AdaptationWheelArmorRenderer extends GeoArmorRenderer<AdaptationWheelItem> {
	public AdaptationWheelArmorRenderer() {
		super(new AdaptationWheelModel());
	...
	@Override
	public RenderType getRenderType(AdaptationWheelItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
