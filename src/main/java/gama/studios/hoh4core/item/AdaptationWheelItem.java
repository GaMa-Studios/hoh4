...
import gama.studios.hoh4core.client.renderer.AdaptationWheelArmorRenderer;

public class AdaptationWheelItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public AdaptationWheelItem(ArmorItem.Type type, Item.Properties properties) {
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new AdaptationWheelArmorRenderer();
