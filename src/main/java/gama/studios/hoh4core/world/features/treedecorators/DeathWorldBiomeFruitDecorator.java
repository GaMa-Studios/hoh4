...
package gama.studios.hoh4core.world.features.treedecorators;
...
public class DeathWorldBiomeFruitDecorator extends CocoaDecorator {
	public static Codec<DeathWorldBiomeFruitDecorator> CODEC = Codec.unit(DeathWorldBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("death_world_biome_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public DeathWorldBiomeFruitDecorator() {
		super(0.2f);
	}
