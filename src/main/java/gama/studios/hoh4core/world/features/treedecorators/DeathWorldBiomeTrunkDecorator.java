...
public class DeathWorldBiomeTrunkDecorator extends TrunkVineDecorator {
	public static Codec<DeathWorldBiomeTrunkDecorator> CODEC = Codec.unit(DeathWorldBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("death_world_biome_tree_trunk_decorator", DECORATOR_TYPE));
	}
