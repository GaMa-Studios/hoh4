...
public class Hoh4CoreModEntities {
	...
	public static final RegistryObject<EntityType<CrystalEntity>> CRYSTAL = register("crystal",
			EntityType.Builder.<CrystalEntity>of(CrystalEntity::new, MobCategory.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(16).setUpdateInterval(3).setCustomClientFactory(CrystalEntity::new).fireImmune().sized(0.6f, 1.8f));
